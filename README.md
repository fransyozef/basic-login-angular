...
## Feature "Items"
What's a secured dashboard if you don't have any content to show? In this template I've included a basic feature with Items. You can add / delete / edit items using the CRUD methods. The data is stored in a BehaviourSubject store. The api calls are intercepted by the fake backend api server.
