...
- Feature "Items"   : Add / Delete / Edit items
...
### Feature "Items"
What's a secured dashboard if you don't have any content to show? In this template I've included a basic feature with Items. You can add / delete / edit items. The data is stored in a BehaviourSubject store. 
